...
export const createPromiseThunk = (type, promiseCreator) => {
    ...
    // 만약 여러 종류의 파라미터를 전달해야하는 상황에서는 객체 타입의 파라미터를 받아오도록하면 됩니다.
...
export const reducerUtils = {
    // 초기 상태. 초기 data 값은 기본적으로 null이지만 바꿀 수도 있습니다.
    ...
    // 따로 값을 지정하면 null로 바꾸지 않고 다른값을 유지시킬 수 있습니다.
...
export const createPromiseThunkById = (
    type,
    promiseCreator,
    // 파라미터에서 id를 어떻게 선택할지 정의하는 함수입니다.
